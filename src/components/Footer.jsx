    ...
    return (
        <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
            <div>
                ...
                <p className='py-4'>
                    Dedicated to delivering innovative solutions that empower businesses and individuals. With a 
                    focus on quality, integrity, and customer satisfaction, we strive to create value and drive
                     success.
                </p>
            ...
            <div className='lg:col-span-2 flex justify-between mt-6 lg:px-5'>
                <div>
                ...
                <div>
                    <h6 className='font-medium text-gray-600'>See Company</h6>
                    <ul>
